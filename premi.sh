...
echo -e "   Author : ${green}Bogel Tunneling ® ${NC}${YELLOW}(${NC} ${green} Bogel Tunneling ${NC}${YELLOW})${NC}"
echo -e "   © Recode By Bogel Tunneling ® ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/wggly/new/main/regis | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/wggly/new/main/regis | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/wggly/new/main/regis | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/wggly/new/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/wggly/new/main/regis | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/wggly/new/main/regis | grep $ipsaya | awk '{print $3}')
...
port 587
auth on
user jlimuly@gmail.com
from jlimuly@gmail.com
password Apalah771 
logfile ~/.msmtp.log
EOF
